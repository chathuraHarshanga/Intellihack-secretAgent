...
import 'package:heart_rp/screens/signup_screen.dart';
...
class _WelcomeScreenState extends State<WelcomeScreen> {
  Widget _submitButton() {
    return InkWell(
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => LoginScreen(title: '',)));
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: <BoxShadow>[
              BoxShadow(
                  color: Color(0xFF3B72FF).withAlpha(100),
                  offset: Offset(2, 4),
                  blurRadius: 8,
                  spreadRadius: 2)
            ],
        ...
        child: Text(
          'Login',
          style: TextStyle(fontSize: 20, color: Color(0xFF3B72FF)),
        ),
      ),
    );
  }
